...
const I18N = {
  en: {
    ...
    'hero.lead': 'BubbleTranslate is a desktop app that translates the text you select — when you ask it to. Hold <b>Shift</b> and highlight text in a PDF, a terminal, a browser, or an editor, and a bubble appears right at your cursor with the translation. <b>It detects the language for you</b> — you never say what you\'re reading — and translates into the language you chose. No copy-paste, no switching windows.',
  ...
  tr: {
    ...
    'hero.lead': 'BubbleTranslate, seçtiğiniz metni — siz istediğinizde — çeviren bir masaüstü uygulamasıdır. <b>Shift</b>\'e basılı tutup bir PDF\'te, terminalde, tarayıcıda veya editörde metni seçin; imlecinizin yanında çevirisiyle bir baloncuk belirir. <b>Dili sizin için algılar</b> — ne okuduğunuzu asla söylemezsiniz — ve seçtiğiniz dile çevirir. Kopyala-yapıştır yok, pencere değiştirmek yok.',
  ...
  es: {
    ...
    'hero.lead': 'BubbleTranslate es una app de escritorio que traduce el texto que seleccionas, cuando se lo pides. Mantén <b>Shift</b> y resalta texto en un PDF, una terminal, un navegador o un editor, y aparece una burbuja justo junto al cursor con la traducción. <b>Detecta el idioma por ti</b> — nunca dices qué estás leyendo — y traduce al idioma que elijas. Sin copiar y pegar, sin cambiar de ventana.',
