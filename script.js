...
const I18N = {
  en: {
    ...
    'dl.linux.ocr': 'To read text off the screen with <b>Ctrl+Shift+E</b>, install Tesseract once, with a pack for each language you read <i>from</i> (eng, tur, deu, spa…):',
    ...
    'faq.a4': 'macOS, Windows and Linux. The Windows build is one .exe that needs nothing installed and runs on Windows 10 and 11, including ARM machines. On Linux the download runs on any distribution with glibc 2.28 or newer — Ubuntu 20.04, Debian 10, Fedora, Arch and everything since; reading text off the screen also needs Tesseract, installed once.',
  ...
  tr: {
    ...
    'dl.linux.ocr': 'Ekrandaki yazıyı <b>Ctrl+Shift+E</b> ile okumak için Tesseract\'ı bir kez kurun; okuduğunuz her dil için bir dil paketiyle (tur, eng, deu, spa…):',
  ...
  es: {
    ...
    'dl.linux.ocr': 'Para leer texto de la pantalla con <b>Ctrl+Shift+E</b>, instala Tesseract una vez, con un paquete por cada idioma que lees (spa, eng, deu, tur…):',
