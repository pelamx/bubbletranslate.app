...
const I18N = {
  en: {
    ...
    'dl.linux.ocr.sum': 'Reading text off the screen (Ctrl+Shift+E)',
  ...
  tr: {
    ...
    'dl.linux.ocr.sum': 'Ekrandaki yazıyı okuma (Ctrl+Shift+E)',
  ...
  es: {
    ...
    'dl.linux.ocr.sum': 'Leer texto de la pantalla (Ctrl+Shift+E)',
